...
class DoublyLinkedList {
    ...
    isPalindrome(){
        ...
        let headTrack = this.head;
        let tailTrack = this.tail;
        while (headTrack != null || tailTrack != null) {
            if(headTrack.value != tailTrack.value) return false;
            headTrack = headTrack.next;
            tailTrack = tailTrack.prev;
        }        
        return true;
    }
